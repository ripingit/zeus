...
<div class="row">
		...
		<div class="form-horizontal col-md-6" style="margin:10px 0 0 -100px">
			<table style="width:100%;" border="0" > 
					...
					<img alt="暂无图片" id="preview_img" name="preview_img" src="<%=basePath%>images/zanwu.png"/>
		...
		<div class="form-group">
					    <div class="col-sm-offset-2 col-sm-5">
					      <button class="btn btn-primary" onclick="submit()">提交</button>
					       <button class="btn btn-default" onclick="loadProduct()">返回</button>
					    </div>
					  </div>
...
//	console.log(data)
	...
	for(var i=0;i<data.length;i++)
		...
		for(var j=0;j<data2.length;j++)
			{
			str+="<li role='attr' code="+data2[j].code+"><a href='javascript:void(0)'>"
			str+=data2[j].title		
			str+="</a></li>"
			}
		str+="</ul>"
...
var submit=function(){
   ...
   if(sortId==null)
	...
	$.ajax({
		   type: "post",
		   url: "<%=basePath%>/showroom/product/dyAddProduct",
